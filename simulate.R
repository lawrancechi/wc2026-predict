...
cd_js <- paste(
  ...
  "    '<div class=\"cd-twtime\">\U0001F1F9\U0001F1FC 台灣時間約 '+twt+' 開賽 · <a href=\"https://www.google.com/search?q=台灣運彩+世界盃+賠率\" style=\"color:#34d399\">確認運彩賽程</a></div>'+",
  "    '<div class=\"cd-digits\">'+",
...
<div class="hero">
  ...
  <div class="sporttery-bar">
    <a href="https://www.google.com/search?q=台灣運彩+世界盃+賠率" class="sporttery-btn">
      🎯 台灣運彩官網（查詢最新賠率）
    </a>
